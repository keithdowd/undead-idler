...
- [x] Full automated suite passes: 113 tests.
...
- [x] Packaged visual checks of the Settings, About, and tooltip surfaces pass on the rebuilt package.
...
- Interactive visual checks of Settings, About, and the tooltip pass on the rebuilt package.
